req=(function(e,t,n){function i(n,s){if(!t[n]){if(!e[n]){var o=typeof req=="function"&&req;if(!s&&o)return o(n,!0);if(r)return r(n,!0);throw new Error("Cannot find module '"+n+"'")}var u=t[n]={exports:{}};e[n][0].call(u.exports,function(t){var r=e[n][1][t];return i(r?r:t)},u,u.exports)}return t[n].exports}var r=typeof req=="function"&&req;for(var s=0;s<n.length;s++)i(n[s]);return i})({"/home/fsousa/src/crp/embers/engine/src/program.js":[function(req,module,exports){
module.exports=req('nI/ryr');
},{}],"nI/ryr":[function(req,module,exports){
...
module.exports = function (dataArray, rowsPC, colsPC, aspectMapPC, slopeMapPC, clcMapPC, heightPC, widthPC){
  ...
  var fireLib = req('./fireLib');
  //var fireLib = req('./slowFGM');
...
},{"./fireLib":1}],1:[function(req,module,exports){
/*
